...
/** Action to re-load classes and apply to edited display
 *  @author Kay Kasemir
 */
@SuppressWarnings("nls")
public class ReloadClassesAction extends Action
{
    private final DisplayEditorPart editor;

    public ReloadClassesAction(final DisplayEditorPart editor)
    {
        super(org.csstudio.display.builder.rcp.Messages.ReloadClasses,
