...
public class WidgetFontPopOverController implements Initializable {
     ...
     * ---- font property -----------------------------------------------------
     */
    private final ObjectProperty<WidgetFont> font = new SimpleObjectProperty<WidgetFont>(this, "font", new WidgetFont("", WidgetFontStyle.REGULAR, Double.NaN)) {
        @Override
    ...
    public void initialize ( URL location, ResourceBundle resources ) {
        ...
        styles.setItems(new SortedList<WidgetFontStyle>(
